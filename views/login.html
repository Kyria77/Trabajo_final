...
<html lang="es">
    ...
    <body>
            ...
            <div class="main_cabecera">
                ...
                <nav class="main_nav_content">
                    <ul class="main_navLinks">
                        <li><a class="out_login" href="./registro.php">Registrarse</a></li>
                        <li><a class="inn_login" href="#">Iniciar sesión</a></li>
                    </ul>
                </nav>
            </div>
        ...
        <script src="../assets/scripts/validacion_login.js"></script>
    </body>
</html>